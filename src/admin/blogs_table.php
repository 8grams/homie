...
?>
<div class="flex flex-col" x-data="{ deleting: null }">
        ...
        <table
          ...
          <thead class="bg-gray-100 dark:bg-gray-700">
            <tr>
              ...
              <th
                scope="col"
                class="p-4 w-1 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-400">
                Actions
              </th>
            </tr>
          </thead>
            ...
            <?php foreach ($blogs as $blog): ?>
              <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                ...
                <td class="p-4 space-x-2 whitespace-nowrap">
                  <a
                    href="/admin/blogs_form?id=<?= $blog->id ?>"
                  ...
                  <button
                    ...
                    data-id="<?= $blog->id ?>"
                    x-on:click="deleting = $el.dataset.id"
  ...
  <div id="drawer-delete-product-default" class="fixed top-0 right-0 z-40 w-full h-screen max-w-xs p-4 overflow-y-auto transition-transform bg-white dark:bg-gray-800 translate-x-full" tabindex="-1" aria-labelledby="drawer-label" aria-hidden="true">
    ...
    <form action="/admin/blogs_delete" method="post">
      <input type="hidden" name="id" x-bind:value="deleting">
      <button href="#" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2.5 text-center mr-2 dark:focus:ring-red-900">
        Yes, I'm sure
      </button>
